        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
            ...
            <div data-kt-menu-trigger="click"
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'User List'){ echo "active";}?>"
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion <?php if($title == 'Transactions'){ echo "hover show";}?>">
                <span class="menu-link">
                    <span class="menu-icon">
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'Deposits'){ echo "active";}?>"
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion <?php if($title == 'General'){ echo "hover show";}?>">
                <span class="menu-link">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                        <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'Add Distributors'){ echo "active";}?>"
                            href="<?php echo base_url(); ?>organization/organization-add">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'Distributors'){ echo "active";}?>"
            ...
            <div data-kt-menu-trigger="click"
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'Add Client'){ echo "active";}?>"
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'Client List'){ echo "active";}?>"
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion <?php if($title == 'Product'){ echo "hover show";}?>">
                <span class="menu-link">
                    <span class="menu-icon">
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'Add Category'){ echo "active";}?>"
                            href="<?php echo base_url(); ?>product/category-add">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'Category List'){ echo "active";}?>"
                            href="<?php echo base_url(); ?>product/category-show">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'Add Product'){ echo "active";}?>" href="<?php echo base_url(); ?>product/add-product">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link <?php if($subtitle == 'Product List'){ echo "active";}?>" href="<?php echo base_url(); ?>product/product-show">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
