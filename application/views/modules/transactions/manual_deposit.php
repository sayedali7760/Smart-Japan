<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <?php
            echo form_open_multipart('transaction/manual_deposit', array('id' => 'deposit_save', 'role' => 'form', 'class' => 'form d-flex flex-column flex-lg-row'));
            ?>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                            ...
                                            <select class="form-select mb-5" data-control="select2"
                                                ...
                                                if (isset($account_details) && !empty($account_details)) {
                                                    foreach ($account_details as $account) {
                                                        echo '<option value ="' . $account->login . '">' . $account->login . ' / ' . $account->name . '</option>';
                                                    }
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="d-flex flex-wrap gap-5">
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input type="text" class="form-control mb-5" id="amount" name="amount"
                                                placeholder="Deposit Amount" maxlength="10">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <a href="<?php echo base_url(); ?>transaction/manual-deposit" id="kt_ecommerce_add_product_cancel"
...
<script>
    function submit_data() {
        $("#actual_submit").hide();
        $("#loader_submit").show();
        var ops_url = baseurl + 'transaction/manual-save';
