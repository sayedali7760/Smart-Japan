                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_sales_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-start min-w-75px">Username</th>
                                <th class="text-strat min-w-75px">Email</th>
                                <th class="text-strat min-w-75px">Discount</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                <td><?php echo $i;?></td>
                                <td class="text-start pe-0"><?php echo $client->fname; ?></td>
                                <td class="text-start pe-0"><?php echo $client->lname; ?></td>
                                <td class="text-start pe-0"><?php echo $client->username; ?></td>
                                <td class="text-start pe-0"><?php echo $client->email; ?></td>
                                <td class="text-start pe-0"><?php echo $client->discount; ?></td>
                                <td class="text-start pe-0"><?php echo date('d/m/Y', strtotime($client->created_on)); ?>
