								...
								<div class="col-xl-4">
									...
									<div class="row mb-5 mb-xl-8 g-5 g-xl-8">
										...
										<div class="col-6">
											...
											<div class="card card-stretch">
												<!--begin::Link-->
												<a href="<?php echo base_url();?>client-crm/show-product" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
								...
								<div class="col-xl-8 ps-xl-12">
									...
									<div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-primary mb-5 mb-xl-8" style="background-color: ;background-position: 100% 50px;background-size: 500px auto;background-image:url('assets/media/misc/city.png')">
										...
										<div class="card-body d-flex flex-column justify-content-center ps-lg-12">
											...
											<br>Welcome to an exciting new experience! </h3>
											<!--end::Title-->
											<!--begin::Action-->
											<div class="m-0">
												<a href="#" class="btn btn-success fw-bold px-6 py-3" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Create a Order</a>
											</div>
											<!--begin::Action-->
										</div>
										<!--end::Body-->
