	...
	<div class="container-xxl" id="kt_content_container">
		...
		<div class="alert alert-danger d-flex align-items-center p-5 mb-10">
			...
			<div class="d-flex flex-column">
				<h4 class="mb-1 text-danger">Please upload documents to verify your account</h4>
		...
		<div class="row g-5 g-xl-8">
			...
			<div class="col-xl-8 ps-xl-12">
				...
				<div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px mb-5 mb-xl-8" style="background-color: #1f2446;background-position: 100% 50px;background-size: 500px auto;background-image:url('assets/media/misc/city1.png')">
					<!--begin::Body-->
					<div class="card-body d-flex flex-column justify-content-center ps-lg-12">
						<!--begin::Title-->
						<h3 class="text-white fs-2qx fw-bolder mb-7">Hello <?php echo $this->session->userdata('fname'); ?>
							<br>Welcome to an exciting new experience!
						</h3>
						<!--end::Title-->
						<!--begin::Action-->
						<div class="m-0">
							<a href="<?php echo base_url(); ?>client/my-profile" class="btn btn-success fw-bold px-6 py-3">Verify Account</a>
						</div>
						<!--begin::Action-->
					</div>
					<!--end::Body-->
